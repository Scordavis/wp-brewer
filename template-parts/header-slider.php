			...
			<div class="slide__content">
				<div class="container slide__content-wrap">
					<section class="slide__text">
						...
						<a href="<?php echo get_field('slide-link'); ?>" class="slide__text-link visible-md visible-lg" style="color: <?php echo get_field('buton-color'); ?>"><i class="top-border-btn" style="background-color: <?php echo get_field('buton-color'); ?>"></i><?php echo get_field('slide-btn'); ?><i class="bottom-border-btn" style="background-color: <?php echo get_field('buton-color'); ?>"></i></a> 
						<a href="<?php echo get_field('slide-link'); ?>" class="slide__text-link visible-sm visible-xs" style="color: <?php echo get_field('buton-color'); ?>; background-color: <?php echo get_field('slide-button-bg'); ?>"><?php echo get_field('slide-btn'); ?></a> 
					</section>
				</div>
			</div>
		</div>
